...
######################################
# Definiowanie świata
world_name = 'world_PWK2022'  # 'world_RumcajsStory'
...
while True:  # dopóki nie zakończymy, będziemy aplikować kolejne działania
    ...
    if chosen_action == 0:  # Usuń niepotrzebne węzły
        ...
        d_dir   = f'{json_path}/{world_name}_{date_folder}'
        draw_graph(world, d_title, d_desc, d_file, d_dir, red_nodes, allowed_layers=layers_to_draw)
        ...
        if node_to_change_paths:
            ...
            if how_many > 1:
                ...
                d_dir   = f'{json_path}/{world_name}_{date_folder}'
                draw_graph(world, d_title, d_desc, d_file, d_dir, comments, allowed_layers=layers_to_draw)
                comments = {}
        ...
        d_dir   = f'{json_path}/{world_name}_{date_folder}'
        draw_graph(world, d_title, d_desc, d_file, d_dir, red_nodes, red_edges, allowed_layers=layers_to_draw)
