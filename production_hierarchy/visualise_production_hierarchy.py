...
if production_hierarchy_tests:
    ...
    for quest_json in jsons_schema_OK:
        ...
        if prod_hierarchy:
            draw_production_tree(prod_hierarchy, missing=m, mission_name=f'hierarchia_produkcji_{quest_json["file_path"].split(os.sep)[-1].rsplit(".",1)[0]}', title_list_for_bold=title_list_for_bold)
