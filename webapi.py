...
# definicje
# definiowanie świata
world_name = 'quest00_world_DragonStory' #'World_PWK2021_misje_P' #'world_RumcajsStory'  #'World_PWK2021_Main_13_do_testow'"World_q00"
# definiowanie misji
quest_names = [
    'quest00_DragonStory' #"quest2021-04_Tax_to_pay" 'quest_RumcajsStory_close'
...
async def index():
    ...
    <html>
        ...
        <body>
            ...
            <p> </p>
            <a href="/getWorld"> Get World </a>
            <h1>Post methods</h1>
            <a href="/postNewWorld"> Post new world method (POST METHOD DONT click ;)  </a>
            <p> </p>
            <a href="/generateMap"> generate Map (POST METHOD DONT click ;)  </a>
        </body>
    </html>
    """
...
async def action(request: GameRequest2):
    ...
    try:
        character_paths = looking_for_main_character_for_api(
            gameplay,
            current_world,
            name_or_id=character.get("Id") if character.get("Id") else character.get("Name") , # bieżący bohater
