...
# definicje
# definiowanie świata
world_name = 'quest00_world_DragonStory'  # quest2023_6_01_world_Potion_for_Triss #'world_DragonStory'   #   #'world_RumcajsStory'
# definiowanie misji
quest_names = ['quest00_DragonStory']  # 'quest2023_6_01_Potion_for_Triss''quest_RumcajsStory_close'
